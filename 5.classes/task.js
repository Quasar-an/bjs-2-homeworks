class PrintEditionItem {
  ...
  console.log("Количество книг после попытки добавления повреждённой книги: " + library.books.length);
  ...
  class Student {
    ...
    getAverageBySubject(subject) {
      ...
      const totalMarks = this.marks[subject].reduce((sum, mark) => sum + mark, 0);
